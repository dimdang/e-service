...
<head>
  ...
  <script src='./resources/swagger/lib/object-assign-pollyfill.js' type='text/javascript'></script>
  ...
  <script src='./resources/swagger/lib/handlebars-4.0.5.js' type='text/javascript'></script>
    ...
    $(function () {
      ...
      if (url && url.length > 1) {
        url = decodeURIComponent(url[1]);
          ...
          url = "${pageContext.request.contextPath}/v2/api-docs"
...
<div id='header'>
  <div class="swagger-ui-wrap">
    <a id="logo" href="http://swagger.io"><img class="logo__img" alt="swagger" height="30" width="30" src="./resources/swagger/images/logo_small.png" /><span class="logo__title">swagger</span></a>

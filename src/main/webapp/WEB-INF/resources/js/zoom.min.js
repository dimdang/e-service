!function (o) {
    function i(i) {
        ...
        if (n) {
            ...
            h.append(a), d.html("").delay(500).addClass("loading"), d.prepend(r), a.load(e).attr("src", n), s = t,
                ...
                $('.download').attr('href', 'http://localhost:8080/api/web/image/download/' + id),
                $('.delete').attr('href', 'http://localhost:8080/api/web/image/delete/' + id),
                $('.delete').attr('id', id)
        ...
        if (confirm("Are you sure you want to delete this image?")) {
            ...
            $.ajax({
                ...
                error: function (response) {
                    alert("Remove image from server error!");
                    console.log(response);
                }
            });
        } else {
    ...
    var h = o("body");
    h.append('<div id="zoom"><a class="delete"><span class="glyphicon glyphicon-trash"></span></a><a class="download"><span class="glyphicon glyphicon-download-alt"></span></a><a class="close"></a><a href="#previous" class="previous"></a><a href="#next" class="next"></a><div class="content loading"></div></div>');
    var l = o("#zoom").hide(),
        d = o("#zoom .content"),
    ...
    !function () {
        ...
        }), o("#zoom .close").on("click", n), o("#zoom .previous").on("click", e), o("#zoom .next").on("click", t), o("#zoom .download").on("click", download), o("#zoom .delete").on("click", remove), o(document).keydown(function (o) {

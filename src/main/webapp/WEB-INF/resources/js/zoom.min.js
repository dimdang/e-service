!function (o) {
    ...
    var h = o("body");
    h.append('<div id="zoom"><a class="delete">Remove</a><a class="download">Download</a><a class="close"></a><a href="#previous" class="previous"></a><a href="#next" class="next"></a><div class="content loading"></div></div>');
    var l = o("#zoom").hide(),
        d = o("#zoom .content"),

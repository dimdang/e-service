!function (o) {
    ...
    $.fn.imageOnClick = function (obj) {
        console.log(obj);
        obj.find("a").on("click", i);
    }
        ...
        swal({
            ...
            preConfirm: function () {
                return new Promise(function (resolve, reject) {
                    setTimeout(function () {
                        $.fn.addMoreImage($('.gallery').attr('id'), resolve, reject, callback);
                    }, 4000)
                })
            },
                ...
                success: function (response) {
                    if (images != null) {
                        ...
                        for (var i = 0; i < advertisement.length; i++) {
                            if (id == advertisement[i].IMAGE.ID) {
                                advertisement.splice(i, 1);
                                $("#" + id).parent().remove();
                                console.log($("img[name=" + id + "]"));
                                $("img[name=" + id + "]").parent().remove();
                                console.log("====>>> Remain advertisement:" + advertisement.length);
                    ...
                    alertify.log("Your image has been deleted.", "success", 2000);
    ...
    var h = o("body");
    if ($('.container').attr('id') == "CUS") {
        h.append('<div id="zoom"><a class="download" title="download image"><span class="glyphicon glyphicon-download-alt"></span></a><a class="close"></a><a href="#previous" class="previous"></a><a href="#next" class="next"></a><div class="content loading"></div></div>');
        $(".download").css("margin-right", "50px");
    } else {
